...
%insertar imagenes en encabezados y pie de pagina
\usepackage{graphicx}
\usepackage{fancyhdr}
\geometry{left=2.54cm, right=2.54cm, top=2.54cm, bottom=2.54cm}

\pagestyle{fancy}
\chead{\includegraphics[width=\textwidth]{encabezado}}
\cfoot{\includegraphics[width=\textwidth]{pie}}
...
% Triángulo obtusángulo
    ...
    \begin{paracol}{2}
        ...
        \switchcolumn
        \textcolor{red}{Lqqd} \boxed{\sin^2(x) + \cos^2(x) =\sin^2(x) + \cos^2(x)}
    \end{paracol}
    \newpage
