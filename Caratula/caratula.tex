...
% Triángulo obtusángulo
    ...
    \begin{paracol}{2}
        ...
        \begin{enumerate} \setcounter{enumi}{6}
            ...
            \item $\cos^{-1}(x)$\\[0.5cm]
            $\cos^{-1}(x)=-\dfrac{1}{\sqrt{1-x^2}}$\\[0.5cm]
            \item $\tan^{-1}(x)$\\[0.5cm]
            $\tan^{-1}(x)=\dfrac{1}{1+x^2}$\\[0.5cm]
            \item $\cot^{-1}(x)$\\[0.5cm]
            $\cot^{-1}(x)=-\dfrac{1}{1+x^2}$\\[0.5cm]
            \item $\sec^{-1}(x)$\\[0.5cm]
            $\sec^{-1}(x)=\dfrac{1}{|x|\sqrt{x^2-1}}$\\[0.5cm]
            \item $\csc^{-1}(x)$\\[0.5cm]
            $\csc^{- 1}(x)=-\dfrac{1}{|x|\sqrt{x^2-1}}$\\[0.5cm]
        \end{enumerate}
